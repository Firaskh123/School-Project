        ...
        <td style="width: 1125px">
            <div style="text-align: center">
                <asp:Panel ID="Panel1" runat="server" Height="100%" Width="100%">
                    ...
                    <br />
                    <asp:GridView ID="GridViewAllUsers" runat="server" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" AutoGenerateColumns="False" DataKeyNames="FN" DataSourceID="SqlDataSource1" AllowSorting="True" GridLines="Vertical" OnRowDeleting="GridViewAllUsers_RowDeleting" AutoGenerateDeleteButton="True" AutoGenerateSelectButton="True" OnSelectedIndexChanged="GridViewAllUsers_SelectedIndexChanged">
